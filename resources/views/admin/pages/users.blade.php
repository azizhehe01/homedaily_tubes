                    ...
                    <div id="modal-input"
                        ...
                        <div
                            ...
                            <div class="flex flex-col border rounded-lg shadow-sm pointer-events-auto border-default-200">
                                ...
                                <form action="{{ route('admin.pages.users.store') }}" method="POST" class="p-4">
                                    @csrf
                                    <div class="space-y-4">
                                        <div>
                                    ...
                                    <div
                                        class="flex items-center justify-end px-4 py-3 mt-4 border-t gap-x-2 border-default-200">
                                        <button type="button"
                                            ...
                                            data-hs-overlay="#modal-input">
                                            Close
                                        </button>
                                        <button type="submit"
                                            class="inline-flex items-center justify-center px-5 py-2 text-sm font-medium tracking-wide text-center text-white align-middle duration-500 border rounded-md bg-primary hover:bg-primary-700 border-primary hover:border-primary-700">
                                            Save User
                                        </button>
                                    </div>
                                </form>
