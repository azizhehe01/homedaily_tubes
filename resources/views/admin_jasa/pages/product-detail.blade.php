...
@section('content')
    <div class="container-fluid py-6 px-4">
        @include('admin_jasa.layouts.page-title', [
            'title' => 'Detail jasa',
            'subtitle' => 'Detailed information about the service',
        ])
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="p-4 border-b">
                <a href="{{ route('admin_jasa.pages.products') }}" 
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex space-x-4 pt-4">
                        ...
                        <form action="{{ route('admin_jasa.pages.products.destroy', $product->product_id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" 
