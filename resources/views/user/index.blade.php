...
<body class="bg-white">
    <!-- Navigation Header -->
    <header class="container flex items-center justify-between px-4 py-6 mx-auto border-b-2">
        <a href="#" class="w-40">
            <img src="{{ 'assets/images/logo-primary.jpg' }}" alt='Logo Primary' />
        </a>
        <nav>
            <ul class="flex space-x-8">
                <li><a href="#" class="font-medium text-orange-600">Home</a></li>
                <li><a href="#" class="font-medium text-gray-900 hover:text-orange-600">Browse by</a></li>
                <li><a href="#" class="font-medium text-gray-900 hover:text-orange-600">Stories</a></li>
                <li><a href="#" class="font-medium text-gray-900 hover:text-orange-600">Agents</a></li>
                <li>
                    <a href="{{ route('login') }}" class="font-medium text-gray-900 hover:text-orange-600">Login</a>
                </li>
            </ul>
        </nav>
    </header>
    ...
    <section>
        <div class="container p-4 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <!-- Product 1 (Larger) -->
                <div class="relative overflow-hidden bg-gray-800 rounded-lg sm:col-span-2 sm:row-span-2">
                    <img src="{{ 'assets/images/pic.png' }}" alt="Blue Origin Farms"
                        class="z-0 object-cover w-full h-full max-h-96">
                    <div class="absolute bottom-0 left-0 z-10 p-4">
                        <h3 class="text-lg font-semibold text-white">Blue Origin Farms</h3>
                        <p class="text-sm text-white">Jakarta, Indonesia</p>
                    </div>
                    <div
                        class="absolute top-0 right-0 z-10 flex items-center justify-center py-3 pl-8 text-2xl font-bold text-white bg-yellow-600 rounded-bl-full w-72">
                        Rp 200,000
                    </div>
                </div>
                ...
                <div class="relative overflow-hidden bg-gray-800 rounded-lg">
                    <img src="{{ 'assets/images/pic (1).png' }}" alt="Ocean Land" class="z-0 object-cover w-full h-48">
                    <div class="absolute bottom-0 left-0 z-10 p-4">
                        <h3 class="text-lg font-semibold text-white">Ocean Land</h3>
                        <p class="text-sm text-white">Bandung, Indonesia</p>
                    </div>
                    <div
                        class="absolute top-0 right-0 z-10 flex items-center justify-center w-32 py-1 pl-4 font-bold text-white bg-yellow-600 rounded-bl-full text-large">
                        Rp 200,000
                    </div>
                </div>
                ...
                <!-- Product 3 -->
                <div class="relative overflow-hidden bg-gray-800 rounded-lg">
                    <img src="{{ 'assets/images/pic (2).png' }}" alt="Stark House" class="z-0 object-cover w-full h-48">
                    <div class="absolute bottom-0 left-0 z-10 p-4">
                        <h3 class="text-lg font-semibold text-white">Stark House</h3>
                        <p class="text-sm text-white">Malang, Indonesia</p>
                    </div>
                    <div
                        class="absolute top-0 right-0 z-10 flex items-center justify-center w-32 py-1 pl-4 font-bold text-white bg-yellow-600 rounded-bl-full text-large">
                        Rp 200,000
                ...
                <!-- Product 4 -->
                <div class="relative overflow-hidden bg-gray-800 rounded-lg">
                    <img src="{{ 'assets/images/pic (3).png' }}" alt="Vinna Vill"
                        class="z-0 object-cover w-full h-48">
                    <div class="absolute bottom-0 left-0 z-10 p-4">
                        <h3 class="text-lg font-semibold text-white">Vinna Vill</h3>
                        <p class="text-sm text-white">Malang, Indonesia</p>
                    </div>
                    <div
                        class="absolute top-0 right-0 z-10 flex items-center justify-center w-32 py-1 pl-4 font-bold text-white bg-yellow-600 rounded-bl-full text-large">
                ...
                <!-- Product 5 -->
                <div class="relative overflow-hidden bg-gray-800 rounded-lg">
                    <img src="{{ 'assets/images/pic (4).png' }}" alt="Bobox" class="z-0 object-cover w-full h-48">
                    <div class="absolute bottom-0 left-0 z-10 p-4">
                        <h3 class="text-lg font-semibold text-white">Bobox</h3>
                        <p class="text-sm text-white">Medan, Indonesia</p>
                    </div>
                    <div
                        class="absolute top-0 right-0 z-10 flex items-center justify-center w-32 py-1 pl-4 font-bold text-white bg-yellow-600 rounded-bl-full text-large">
                        Rp 200,000
