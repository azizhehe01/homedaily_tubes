    ...
    <div class="container px-4 mx-auto mb-12">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div class="md:col-span-2">
                <img src="{{ asset('storage/' . $product->image) }}" alt="Modern Sofa Main View"
                    class="object-cover w-full h-full rounded-lg">
            </div>
            <div class="grid grid-rows-2 gap-4">
                <img src="https://placehold.co/400x300?text=Side+View" alt="Modern Sofa Side View"
                    class="object-cover w-full h-full rounded-lg">
                <img src="https://placehold.co/400x300?text=Detail+View" alt="Modern Sofa Detail View"
                    class="object-cover w-full h-full rounded-lg">
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                            ...
                            <div class="relative">
                                @if ($relatedProduct->image)
                                    <img src="{{ asset('storage/' . $relatedProduct->image) }}"
                                        alt="{{ $relatedProduct->name }}" class="w-full h-32 object-cover rounded-lg">
                                @else
                                    <img src="https://placehold.co/200x150" alt="{{ $relatedProduct->name }}"
                    ...
                    <div class="flex flex-col gap-6 md:flex-row">
                        ...
                        <div class="flex flex-col justify-center w-full md:w-2/3">
                            ...
                            <p class="text-[#152c5b] text-lg font-medium mb-2">
                                This sofa completely transformed my living room. The quality is exceptional and it's even
                                more
                                comfortable than I expected!
                            </p>
                            <p class="mb-4 text-gray-500">Anggi, Interior Designer</p>
            ...
            <div class="lg:col-span-1">
                <div class="sticky p-6 bg-white border border-gray-200 shadow-sm top-4 rounded-2xl">
                    ...
                    <h3 class="text-[#ea8c00] text-2xl font-bold mb-6">Rp {{ number_format($product->price, 0, ',', '.') }}
                    </h3>
                    ...
                    <form class="flex gap-3 mb-6" action="/booking">
