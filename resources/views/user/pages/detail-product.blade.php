    ...
    <div class="container px-4 mx-auto mb-12">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div class="md:col-span-2">
                <<<<<<< Updated upstream @if ($primaryImage = $product->images->where('is_primary', true)->first())
            ...
            <div class="grid grid-rows-2 gap-4">
                <<<<<<< Updated upstream @foreach ($product->images->where('is_primary', false)->take(2) as $image)
            ...
            <div class="lg:col-span-2">
                            ...
                            @forelse($recommendedProducts as $relatedProduct)
                                <a href="{{ route('user.product.detail', $relatedProduct->product_id) }}"
                                    ...
                                    <a href="{{ route('user.product.detail', $relatedProduct->product_id) }}"
                                        ...
                                        @else
                                            <div
                                                class="flex items-center justify-center w-full h-32 bg-gray-200 rounded-lg">
                                                <div
                                                    class="flex items-center justify-center w-full h-32 bg-gray-200 rounded-lg">
                                                    <span class="text-gray-500">No Image</span>
                                                </div>
                                        @endif
                                        <div class="mt-2">
                                            <h3 class="font-medium text-[#152c5b] truncate">{{ $relatedProduct->name }}
                                            </h3>
                        ...
                        <div class="flex flex-col gap-6 md:flex-row">
                            ...
                            <div class="flex flex-col justify-center w-full md:w-2/3">
                                ...
                                <p class="text-[#152c5b] text-lg font-medium mb-2">
                                    This product completely transformed my space. The quality is exceptional and it's even
                                    more
                ...
                <div class="lg:col-span-1">
                    <div class="sticky p-6 bg-white border border-gray-200 shadow-sm top-4 rounded-2xl">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center">
                                ...
                                <div id="quantityDisplay"
                                    class="flex items-center justify-center w-12 h-8 border-t border-b border-gray-300">1
                                </div>
                        ...
                        <<<<<<< Updated upstream <form class="flex gap-3 mb-6" action="{{ route('booking.form') }}"
                            method="POST">
                            @csrf
                            <input type="hidden" name="product_id" value="{{ $product->product_id }}">
                            <input type="hidden" name="quantity" id="quantityInput" value="1">
                            <button type="submit"
                                class="flex-1 bg-[#ea8c00] text-white py-3 rounded-md font-medium hover:bg-[#d17d00] transition-colors">
                                Add to Cart
                            </button>
                            <button type="button"
                                class="flex-1 border border-[#ea8c00] text-[#ea8c00] py-3 rounded-md font-medium hover:bg-[#fff5e6] transition-colors">
                                Buy Now
                            </button>
                            </form>
                            =======
